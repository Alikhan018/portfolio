...
export default function Editor({ content, file }: EditorProps) {
    ...
    return (
        <div className="flex-1 bg-[#1e1e1e] text-sm overflow-auto">
            <div className="px-4 py-2 border-b border-gray-700 bg-[#2d2d30] text-yellow-400 font-mono text-xs flex items-center">
